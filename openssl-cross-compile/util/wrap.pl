...
BEGIN {
    ...
    require '/Users/sarfokantankafrimpong/Desktop/gloox-1.24.framework/openssl-ios64-xcrun/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/Users/sarfokantankafrimpong/Desktop/gloox-1.24.framework/openssl-ios64-xcrun/test/fips-and-base.cnf';
    shift;
