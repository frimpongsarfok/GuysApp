...
-(instancetype)initWithDataArray:(NSArray*)data{
    ...
    [self.view setBackgroundColor:[UIColor  colorWithRed:1 green:.00f blue:.66 alpha:1]];
    ...
    UIBarButtonItem* itemRight=[[UIBarButtonItem alloc]initWithTitle:@"Share" style:UIBarButtonItemStyleDone target:self action:@selector(shareData)];
